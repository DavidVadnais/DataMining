...
print("\n Number of unique books = " + str(len(set(corrrectLabels)))+"\n")

shs, db = {}, {}

print("##########  kmeans   ##############")
print("solhouette score : \n")
shs=silhouette_score(test.iloc[:,1:], preds[0])
print(shs)
print("davies_bouldin score : \n")
db=davies_bouldin_score(test.iloc[:,1:], preds[0])
print(db)
...
shs=silhouette_score(test.iloc[:,1:], predsHie[0])
print(shs)
print("davies_bouldin score : \n")
db=davies_bouldin_score(test.iloc[:,1:], predsHie[0])
print(db)